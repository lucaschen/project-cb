...
import { getStoredActiveOrganizationId, setStoredActiveOrganizationId } from "@app/lib/storage";
...
export const syncActiveOrganizationId = (organizations: OrganizationPayload[]) => {
