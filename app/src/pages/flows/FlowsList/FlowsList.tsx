...
const FlowsList = () => {
  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-88px)] w-full max-w-6xl flex-col px-6 py-10">
      <header className="space-y-4 rounded-[28px] border border-white/10 bg-slate-950/60 p-6 shadow-panel backdrop-blur">
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="space-y-3">
              ...
              <p className="max-w-2xl text-sm leading-6 text-slate-300">
                ...
                workspace, and continue into top-level metadata editing before
                the deeper builder experience lands.
              </p>
            </div>
